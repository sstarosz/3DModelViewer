...
namespace st::renderer
{
	...
	{
	  public:
		PipelineBuilder2(const VulkanContext& vulkanContext) :
			m_vulkanContext(vulkanContext)
		{
		}

		PipelineBuilder2& setFragmentShader(const std::string& fragmentShader)
		{
			m_fragmentShader = fragmentShader;
			return *this;
		}

		PipelineBuilder2& setVertexShader(const std::string& vertexShader)
		{
